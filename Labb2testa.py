...
def read_test_points("C:\Users\hamid\OneDrive\Skrivbord\Python-labb\testpoints.txt"):
    #Öppnar filen och läser allt som en enda String.
    with open("C:\Users\hamid\OneDrive\Skrivbord\Python-labb\testpoints.txt", 'r') as f:
        text = f.read()
